...
\begin{titlepage}
    ...
    \vspace{0.4in}
    {\huge \textbf{Discrete-time Signal Classifier:}} \\
    \vspace{0.1in}
...
The aim is to classify a given discrete-time signal into energy signal or power signal, or neither of them, and also to find their energy and power. The signal may be represented as a python fn (generating numpy array in varying upper intervals), and the test is done by calling the classifier function.
...
#jupyter python program to classify discrete time signals as energy or power usinfg convergence
...
\begin{minted}[frame=lines, framesep=2mm, baselinestretch=1.2, fontsize=\footnotesize, linenos]{python}
''' 1. Representation of discrete time signals as fns'''
