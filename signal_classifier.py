 ...
 "cells": [
  {
   "cell_type": "code",
   "execution_count": 1,
   "id": "1d03d7c1-1d57-4aa9-a8c1-fdeefc9bb3b6",
   "metadata": {},
   "outputs": [
    {
     "name": "stdout",
    ...
    },
    {
     ...
     "output_type": "stream",
     "text": [
      "/tmp/ipykernel_10827/1962171286.py:69: RuntimeWarning: overflow encountered in power\n",
      "  val = 1.1**n\n",
      "/tmp/ipykernel_10827/1962171286.py:32: RuntimeWarning: overflow encountered in square\n",
      "  E = np.sum(np.abs(x_n)**2)\n",
      "/home/aaron/Documents/signal_classifier/venv/lib/python3.13/site-packages/numpy/_core/fromnumeric.py:83: RuntimeWarning: overflow encountered in reduce\n",
  ...
  },
  {
   ...
   "id": "6c09a58d-8553-4511-a5a1-9415affc8527",
   "metadata": {},
   "outputs": [],
   "source": []
  }
